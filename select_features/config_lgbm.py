LABEL = "value"
FEATS = ['CAT_WB5100_ANN', 'REACHCODE', 'WBAreaType_LakePond', 'TOT_ECOL3_21', 'TOT_OM', 
    'TOT_KFACT_UP', 'TOT_ECOL3_20', 'ACC_ECOL3_20', 'RN', 'area.km2', 'TOT_PERMAVE',
    'TerminalPa', 'DnHydroseq', 'row', 'DnLevelPat', 'lat', 'CAT_RF7100', 'N.RS', 'G.RN',
    'WBAreaType_StreamRiver', 'TOT_ELEV_MEAN', 'TOT_ECOL3_50', 'ACC_ECOL3_50', 'ndssi',
    'UpHydroseq', 'Hydroseq', 'FromNode', 'ToNode', 'LevelPathI', 'UpLevelPat', 'NS',
    'TOT_SANDAVE', 'TOT_SILTAVE', 'TOT_NLCD11_90', 'TOT_ELEV_MAX', 'ACC_RF7100', 'TOT_RFACT',
    'TOT_RF7100', 'CAT_PPT7100_ANN', 'TOT_NO200AVE', 'swir2', 'pwater', 'TOT_KFACT',
    'TOT_NLCD11_82', 'swir2_raw', 'R.NS', 'StreamOrde', 'StreamCalc', 'RS', 'ACC_PPT7100_ANN',
    'TOT_PPT7100_ANN', 'swir1', 'swir1_raw', 'ndvi', 'N.BS', 'N_R', 'NR', 'type_Stream',
    'swir1_sd', 'B.GS', 'SR', 'B.GN', 'B.RN', 'G.BS', 'blue', 'blue_raw', 'type_Lake',
    'B.RS', 'nir', 'nir_raw', 'BG', 'N_S', 'GR', 'R.GN', 'GN2', 'green_raw', 'green',
    'R.BN', 'dw', 'bright_tot', 'RG', 'bright', 'hue', 'GR2', 'BR', 'B.RG', 'red',
