...
params = {'boosting_type': 'goss',
 'learning_rate': 0.006197736027816678,
 'subsample': 0.9518283911347609,
 'n_estimators': 876,
 'max_depth': 7,
 'min_child_samples': 3,
 'min_split_gain': 0.0}
...
pd.DataFrame(list(zip(test_pred, y_test.values)),
               columns =["LGBM", "GT"]).to_csv("optuna_LGBM_results.csv", index=False)